# RareImagery.net Creator Store Pricing – Official 2026 Model
**For every X account selling products**

### Your Costs (super simple)
...
- **Per-Purchase Processing Fee**: **2.9% + $0.30**  
  (charged automatically at checkout – same as Stripe. You keep the rest after payment processor fees)

**Example:**  
Creator sells a $50 product → buyer pays $50 + any shipping/tax.  
You charge the creator an extra **$1.75** ($50 × 2.9% + $0.30).  
...
Your X followers buy → you get paid every single time. Simple.
